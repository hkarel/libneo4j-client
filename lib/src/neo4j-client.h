 ...
 */
#define NEO4J_VERSION "2.3.0"
#define NEO4J_MAJOR_VERSION 2
#define NEO4J_MINOR_VERSION 3
#define NEO4J_PATCH_VERSION 0
 ...
 *
 * @param [connection] The connection.
 * @param [tx_timeout] Transaction timeout in seconds. If 0, set to DEFAULT_TX_TIMEOUT (60).
 ...
 *
 * @param [tx] The transaction.
 * @return 1 if transaction has failed; 0 if not.
 */
__neo4j_must_check
